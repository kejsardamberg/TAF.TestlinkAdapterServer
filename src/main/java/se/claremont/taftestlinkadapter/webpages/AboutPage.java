...
public class AboutPage {
    ...
    public static String toHtml(){
        return InfoPage.toHtml("<h1>TAF Testlink Adapter Server</h1>" +
                ...
                "<tr><td>Listening for incomming TAF test run data on port:</td><td>" + Settings.port + "</td></tr>" +
                ...
                "and maintanable scripts for test automation. It is developed by <a href=\"http://www.claremont.se\">Claremont</a>, a " +
